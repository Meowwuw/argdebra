  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        {/* Banner Header */}
        <div className="relative w-full h-64 bg-gradient-to-r from-blue-600 to-[#00AEFF]">
          <div className="absolute inset-0 bg-black/30"></div>
          <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Convenios Institucionales</h1>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Nuestras Acreditaciones Universitarias</h2>
